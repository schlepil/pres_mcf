...
\begin{frame}
    ...
    \begin{center}
    \textbf{\textbullet Apprentissage par projet \hfill \textbullet Projet pluri-disciplinaire} \\
    \bigskip
...
\begin{frame}
    ...
    \vspace{-10pt}
    \begin{center}
        \textbf{\textbullet~Abstraction du syst\`eme en TA \hspace{10pt} \textbullet~Synth\`ese $\Leftrightarrow$ Atteingnabilit\'e} \\
	\vfill
...
\begin{frame}
    ...
    \begin{center}
        \textbf{\textbullet~Apprendre des mouvements \hspace{10pt} \textbullet~Assurer la stabilit\'e} \\ 
        \vfill
