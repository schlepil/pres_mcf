...
\begin{frame}
    ...
    \begin{tabular}{c|l}
         ...
         2007-11 & \makecell[l]{\tblue{Formation en alternance g\'enie m\'ecanique et m\'ecanicien} \\ \loc{TH N\"urnberg et Schaeffler AG, N\"uremberg, Allemagne} \\ \results{Mention tr\`es bien, 2$^e$/120} } \\ \hline
...
\begin{frame}
    ...
    \vspace{-6pt}
    \begin{center}
        {\large \textbf{Obtenir des garanties formelles pour la commande}}
    \end{center}
